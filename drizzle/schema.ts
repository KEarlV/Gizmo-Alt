...
export const studyCards = mysqlTable("studyCards", {
  ...
  aiDifficulty: mysqlEnum("aiDifficulty", ["easy", "medium", "hard"]).default("medium").notNull(),
  cognitiveSkill: mysqlEnum("cognitiveSkill", ["remember", "understand", "apply", "analyze", "evaluate"]).default("understand").notNull(),
  questionRationale: text("questionRationale"),
